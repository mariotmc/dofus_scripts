function move()
	return {
		...
		{map = "3,-20", changeMap = "left|right", gather = true},
		{map = "2,-20", changeMap = "left", gather = true},
		{map = "1,-20", changeMap = "top", gather = true},
		{map = "1,-21", changeMap = "right", gather = true},
		{map = "2,-21", changeMap = "right", gather = true},
		...
		{map = "6,-22", changeMap = "top", gather = true},
		{map = "6,-23", changeMap = "top|right", gather = true},
		{map = "6,-24", changeMap = "left", gather = true},
		{map = "5,-24", changeMap = "top", gather = true},
		{map = "5,-25", changeMap = "right"},
		{map = "6,-25", changeMap = "right", gather = true},
		...
		{map = "7,-25", changeMap = "bottom", gather = true},
	}
end
